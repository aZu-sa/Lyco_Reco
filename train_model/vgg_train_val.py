...
import train_model.slim.nets.vgg as vgg
...
if __name__ == '__main__':
    train_record_file= 'train_model/dataset/record/train.tfrecords'
    val_record_file= 'train_model/dataset/record/val.tfrecords'
