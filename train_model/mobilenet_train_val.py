...
import train_model.slim.nets.mobilenet_v1 as mobilenet_v1
...
if __name__ == '__main__':
    train_record_file= 'train_model/dataset/record/train224.tfrecords'
    val_record_file= 'train_model/dataset/record/val224.tfrecords'
